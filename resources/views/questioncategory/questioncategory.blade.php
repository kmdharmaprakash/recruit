...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Add Categories and Questions</div>
                       ...
                       <form method="POST" action="{{ url('/addcategory') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <br><br>
                                <ul class="list-group">
                                <li class="list-group-item list-group-item-success"><a class="" href="/categorytypes">Category types</a></li><br><br>

                                <li class="list-group-item list-group-item-success"><a href="/addquestions">Add Question</a></li><br><br>

                                <li class="list-group-item list-group-item-success"><a href="/allquestions">All Questions</a></li>
                              </ul>
                    </form>   
