...
<div class="container">
    ...
    <form method="POST" action="{{ url('/addtrueorfalse') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="select" class="col-md-4 col-form-label text-md-right">{{ __('True or False') }}</label>

                             <div class="col-md-6">
                                  <input type="radio" name="select" value="true" checked>True
                              <input type="radio" name="select" value="false">False
                                @error('select')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
